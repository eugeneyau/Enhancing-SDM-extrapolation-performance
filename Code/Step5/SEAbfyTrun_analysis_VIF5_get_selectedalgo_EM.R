...
filename <- "bmod424_trunc_VIF5_bestalgo_SOUTH_trun20perc"
#filename <- "bmod424_trunc_VIF5_bestalgo_NORTH_trun20perc"
...
ks.test(selected.df$EMca.F, #x
        allalgo.df$EMca.F, #y
        alternative = "greater",exact = NULL, #Alternative: X>Y
        simulate.p.value=FALSE)

ks.test(selected.df$EMmean.F, #x
        allalgo.df$EMmean.F, #y
        alternative = "greater",exact = NULL, #Alternative: X>Y
        simulate.p.value=FALSE)

ks.test(selected.df$EMmedian.F, #x
        allalgo.df$EMmedian.F, #y
        alternative = "greater",exact = NULL, #Alternative: X>Y
        simulate.p.value=FALSE)
