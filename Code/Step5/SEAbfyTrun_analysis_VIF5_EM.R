...
save.filename <- paste0(Analysis,"_TSSNA_VIF5_TruncS20") # Name the df output file
#save.filename <- paste0(Analysis,"_TSSNA_VIF5_TruncN20") # Name the df output file
#save.filename <- paste0(Analysis,"_TSSNA_VIF5_Trunc0") # Name the df output file
...
plot(density(diff.perc.df$EMca.FP.perc,n=10000),xlim = c(-10,100),ylim = c(0,0.03),col="green")
lines(density(diff.perc.df$EMmean.FP.perc,n=10000),col="cyan")
lines(density(diff.perc.df$EMwmean.FP.perc,n=10000),col="blue")
lines(density(diff.perc.df$EMmedian.FP.perc,n=10000),col="purple")

### False positive number
plot(density(diff.perc.df$EMca.FP,n=10000),xlim = c(-1500,10000),ylim = c(0,0.00038),col="green")
lines(density(diff.perc.df$EMmean.FP,n=10000),col="cyan")
lines(density(diff.perc.df$EMwmean.FP,n=10000),col="blue")
lines(density(diff.perc.df$EMmedian.FP,n=10000),col="purple")


### False negative percentage
plot(density(diff.perc.df$EMca.FN.perc,n=10000),xlim = c(-5,50),ylim = c(0,0.08),col="green")
lines(density(diff.perc.df$EMmean.FN.perc,n=10000),col="cyan")
lines(density(diff.perc.df$EMwmean.FN.perc,n=10000),col="blue")
lines(density(diff.perc.df$EMmedian.FN.perc,n=10000),col="purple")

### False negative number
plot(density(diff.perc.df$EMca.FN,n=10000),xlim = c(-2000,10000),ylim = c(0,0.0006),col="green")
lines(density(diff.perc.df$EMmean.FN,n=10000),col="cyan")
lines(density(diff.perc.df$EMwmean.FN,n=10000),col="blue")
lines(density(diff.perc.df$EMmedian.FN,n=10000),col="purple")


### Overall inaccuracy percentage
plot(density(diff.perc.df$EMca.F.perc,n=10000),xlim = c(0,150),ylim = c(0,0.035),col="green")
lines(density(diff.perc.df$EMmean.F.perc,n=10000),col="cyan")
lines(density(diff.perc.df$EMwmean.F.perc,n=10000),col="blue")
lines(density(diff.perc.df$EMmedian.F.perc,n=10000),col="purple")

### Overall inaccuracy number
plot(density(diff.perc.df$EMca.F,n=10000),xlim = c(-1000,25000),ylim = c(0,0.00015),col="green")
lines(density(diff.perc.df$EMmean.F,n=10000),col="cyan")
lines(density(diff.perc.df$EMwmean.F,n=10000),col="blue")
lines(density(diff.perc.df$EMmedian.F,n=10000),col="purple")



########## Stastistically test results ##########

ks.test(diff.perc.df$EMmean.F,
        diff.perc.df$EMwmean.F,
        alternative = "two.sided",exact = NULL, 
        simulate.p.value=FALSE)

ks.test(diff.perc.df$EMmean.FP,
        diff.perc.df$EMwmean.FP,
        alternative = "two.sided",exact = NULL, 
        simulate.p.value=FALSE)

ks.test(diff.perc.df$EMmean.FN,
        diff.perc.df$EMwmean.FN,
        alternative = "two.sided",exact = NULL, 
        simulate.p.value=FALSE)

ks.test(diff.perc.df$EMmedian.FN.perc, #x
        diff.perc.df$EMmean.FN.perc, #y
