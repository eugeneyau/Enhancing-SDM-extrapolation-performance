...
#Import species data
data <- read.csv("Tropical_Asian_Butterflies_May2026.csv")
...
filtered.climate <- subset(current.climate, c("WorldClim_bio01", "WorldClim_bio06", "WorldClim_bio13", "Soilgrids_soil_pH"), negate = TRUE)
terra::writeRaster(filtered.climate, "filtered_current_climate.tif", overwrite=FALSE)
...
write.csv(Cleaned.data, "Cleaned_published_2026data_25.csv", row.names = FALSE)
