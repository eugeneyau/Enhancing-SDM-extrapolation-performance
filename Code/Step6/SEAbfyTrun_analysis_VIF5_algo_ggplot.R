...
save.filename <- "Algo_VIF5_EMca_proj_TSSNA_trunSOUTH" # Name of output file
...
algoplot1 <- ggplot(ggplot.algo.df) + 
  ...
  scale_x_continuous(limits = c(-1.5,18.5), expand=c(0,0), breaks = seq(0,15,5)) +
...
ggsave("algo_VIF5_1col.png", width = 24.5, height = 93.4, units = "cm", dpi = 1000)

ggarrange(algoplot1, algoplot2, algoplot3, algoplot4, algoplot5, algoplot6, algoplot7, algoplot8,
          nrow = 4, ncol = 2, align = "v")
ggsave("algo_VIF5_2col.png", width = 49, height = 46.7, units = "cm", dpi = 1000)



ggarrange(algoplot4, algoplot5, algoplot2,
          nrow = 3, ncol = 1, align = "v")
ggsave("algo_VIF5_sorted1.png", width = 24.5, height = 35, units = "cm", dpi = 1000)

ggarrange(algoplot3, algoplot7, algoplot1,
          nrow = 3, ncol = 1, align = "v")
ggsave("algo_VIF5_sorted2.png", width = 24.5, height = 35, units = "cm", dpi = 1000)



ggarrange(algoplot2, algoplot4, algoplot5,
          nrow = 2, ncol = 2, align = "v")
ggsave("algo_VIF5_sorted_ppt1.png", width = 49, height = 23.35, units = "cm", dpi = 1000)

ggarrange(algoplot7, algoplot3, algoplot1,
          nrow = 2, ncol = 2, align = "v")
ggsave("algo_VIF5_sorted_ppt2.png", width = 49, height = 23.35, units = "cm", dpi = 1000)
