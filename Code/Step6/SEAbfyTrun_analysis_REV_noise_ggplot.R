...
Accuracy_Fun <- function(i) {
  ...
  All.t.FP.perc <- sp.data$All.t.FP.perc
  All.t.FN <- sp.data$All.t.FN
  All.t.FN.perc <- sp.data$All.t.FN.perc
  All.t.F <- sp.data$All.t.F
  All.t.F.perc <- sp.data$All.t.F.perc
  
  All.data <- list(species,All.setup,All.t.FP,All.t.FP.perc,All.t.FN,All.t.FN.perc,All.t.F,All.t.F.perc)
  ...
  BIO.t.FP.perc <- sp.data$BIO.t.FP.perc
  BIO.t.FN <- sp.data$BIO.t.FN
  BIO.t.FN.perc <- sp.data$BIO.t.FN.perc
  BIO.t.F <- sp.data$BIO.t.F
  BIO.t.F.perc <- sp.data$BIO.t.F.perc
  
  BIO.data <- list(species,BIO.setup,BIO.t.FP,BIO.t.FP.perc,BIO.t.FN,BIO.t.FN.perc,BIO.t.F,BIO.t.F.perc)
  ...
  NOI.t.FP.perc <- sp.data$NOI.t.FP.perc
  NOI.t.FN <- sp.data$NOI.t.FN
  NOI.t.FN.perc <- sp.data$NOI.t.FN.perc
  NOI.t.F <- sp.data$NOI.t.F
  NOI.t.F.perc <- sp.data$NOI.t.F.perc
  
  NOI.data <- list(species,NOI.setup,NOI.t.FP,NOI.t.FP.perc,NOI.t.FN,NOI.t.FN.perc,NOI.t.F,NOI.t.F.perc)
...
Fplot <- ggplot(ggplot.df) + 
  stat_density(aes(x=t.F, colour=setup), geom="line", position="identity", linewidth=0.55) +
  ...
  scale_x_continuous(limits = c(-2000,22000),expand=c(0,0), breaks = seq(0,20000,5000)) #+
...
FPplot <- ggplot(ggplot.df) + 
  stat_density(aes(x=t.FP, colour=setup), geom="line", position="identity", linewidth=0.55) +
  #stat_density(aes(x=t.F, colour=setup), geom="line", linetype=5, position="identity", size=0.55) +
  #stat_density(aes(x=f.F, colour=setup), geom="line", position="identity", size=0.55) +
  geom_hline(yintercept = 0, color = "dark grey", linewidth=0.5) +
  theme(panel.grid.major = element_blank(), 
  ...
  scale_color_manual(values=c("#000000","#0077BB","#AA4499")) +
  scale_x_continuous(limits = c(-1200,9000),expand=c(0,0), breaks = seq(0,9000,2500)) #+
  #scale_y_continuous(expand=c(0.025,0)) # c(a,b): a=relative expansion(%) b=absolute expansion
...
FNplot <- ggplot(ggplot.df) + 
  stat_density(aes(x=t.FN, colour=setup), geom="line", position="identity", linewidth=0.55) +
  #stat_density(aes(x=t.F, colour=setup), geom="line", linetype=5, position="identity", size=0.55) +
  #stat_density(aes(x=f.F, colour=setup), geom="line", position="identity", size=0.55) +
  geom_hline(yintercept = 0, color = "dark grey", linewidth=0.5) +
  theme(panel.grid.major = element_blank(), 
  ...
  scale_color_manual(values=c("#000000","#0077BB","#AA4499")) +
  scale_x_continuous(limits = c(-2500,13000),expand=c(0,0), breaks = seq(0,13000,2500)) #+
  #scale_y_continuous(expand=c(0.025,0)) # c(a,b): a=relative expansion(%) b=absolute expansion
