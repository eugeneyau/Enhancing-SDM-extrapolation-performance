...
#save.filename <- "EM_TSSNA_VIF5_TruncN20" # All untuned algo
...
ggsave("EM_VIF5.png", width = 24.5, height = 35, units = "cm", dpi = 1000)
...
ggsave("EMbar_F_VIF5.png", width = 5.65, height = 11.7, units = "cm", dpi = 800)
...
ggsave("EMbar_FP_VIF5.png", width = 5.65, height = 11.7, units = "cm", dpi = 800)
...
ggsave("EMbar_FN_VIF5.png", width = 5.65, height = 11.7, units = "cm", dpi = 800)
...
Fplot <- ggplot(ggplot.df) + 
  stat_density(aes(x=F.perc, colour=setup), geom="line", position="identity", linewidth=0.55) +
  #stat_density(aes(x=t.F, colour=setup), geom="line", linetype=5, position="identity", size=0.55) +
  #stat_density(aes(x=f.F, colour=setup), geom="line", position="identity", size=0.55) +
  geom_hline(yintercept = 0, color = "dark grey", linewidth=0.5) +
  theme(panel.grid.major = element_blank(), 
  ...
  scale_color_manual(values=c("#999933","#0077BB","#AA4499","#33BBEE")) +
  scale_x_continuous(limits = c(-14.5,250), expand=c(0,0), breaks = seq(0,250,50)) +
  scale_y_continuous(expand=c(0.025,0)) # c(a,b): a=relative expansion(%) b=absolute expansion
...
FPplot <- ggplot(ggplot.df) + 
  stat_density(aes(x=FP.perc, colour=setup), geom="line", position="identity", linewidth=0.55) +
  #stat_density(aes(x=t.F, colour=setup), geom="line", linetype=5, position="identity", size=0.55) +
  #stat_density(aes(x=f.F, colour=setup), geom="line", position="identity", size=0.55) +
  geom_hline(yintercept = 0, color = "dark grey", linewidth=0.5) +
  theme(panel.grid.major = element_blank(), 
  ...
  scale_color_manual(values=c("#999933","#0077BB","#AA4499","#33BBEE")) +
  scale_x_continuous(limits = c(-25,200), expand=c(0,0), breaks = seq(0,200,50)) +
  scale_y_continuous(expand=c(0.025,0)) # c(a,b): a=relative expansion(%) b=absolute expansion
...
FNplot <- ggplot(ggplot.df) + 
  stat_density(aes(x=FN.perc, colour=setup), geom="line", position="identity", linewidth=0.55) +
  #stat_density(aes(x=t.F, colour=setup), geom="line", linetype=5, position="identity", size=0.55) +
  #stat_density(aes(x=f.F, colour=setup), geom="line", position="identity", size=0.55) +
  geom_hline(yintercept = 0, color = "dark grey", linewidth=0.5) +
  theme(panel.grid.major = element_blank(), 
  ...
  scale_color_manual(values=c("#999933","#0077BB","#AA4499","#33BBEE")) +
  scale_x_continuous(limits = c(-6,50),expand=c(0,0), breaks = seq(0,50,10)) +
  scale_y_continuous(expand=c(0.025,0)) # c(a,b): a=relative expansion(%) b=absolute expansion
...
### Create new DF 
columns <- c("setup","compare","f.F.sp","f.F.sp.perc","t.F.sp","t.F.sp.perc","t.FP.sp","t.FP.sp.perc","t.FN.sp","t.FN.sp.perc")
ggbar.df <- data.frame(matrix(nrow = 0, ncol = length(columns))) 
colnames(ggbar.df) <- columns
...
if(!is.na(setup4)) {
  setup4.F.more <- length(diff.perc.df[[paste0(setup4, ".F.perc")]][diff.perc.df[[paste0(setup4, ".F.perc")]] >= Fthresh])
  setup4.F.more.perc <- setup4.F.more / length(diff.perc.df[[paste0(setup4, ".F.perc")]])*100
  setup4.F.less <- length(diff.perc.df[[paste0(setup4, ".F.perc")]][diff.perc.df[[paste0(setup4, ".F.perc")]] < Fthresh])
  setup4.F.less.perc <- setup4.F.less / length(diff.perc.df[[paste0(setup4, ".F.perc")]])*100
  
  setup4.FP.more <- length(diff.perc.df[[paste0(setup4, ".FP.perc")]][diff.perc.df[[paste0(setup4, ".FP.perc")]] >= FPthresh])
  setup4.FP.more.perc <- setup4.FP.more / length(diff.perc.df[[paste0(setup4, ".FP.perc")]])*100
  setup4.FP.less <- length(diff.perc.df[[paste0(setup4, ".FP.perc")]][diff.perc.df[[paste0(setup4, ".FP.perc")]] < FPthresh])
  setup4.FP.less.perc <- setup4.FP.less / length(diff.perc.df[[paste0(setup4, ".FP.perc")]])*100
  
  setup4.FN.more <- length(diff.perc.df[[paste0(setup4, ".FN.perc")]][diff.perc.df[[paste0(setup4, ".FN.perc")]] >= FNthresh])
  setup4.FN.more.perc <- setup4.FN.more / length(diff.perc.df[[paste0(setup4, ".FN.perc")]])*100
  setup4.FN.less <- length(diff.perc.df[[paste0(setup4, ".FN.perc")]][diff.perc.df[[paste0(setup4, ".FN.perc")]] < FNthresh])
  setup4.FN.less.perc <- setup4.FN.less / length(diff.perc.df[[paste0(setup4, ".FN.perc")]])*100
}


### Write data
if(!is.na(setup1)) {
  setup1.more.data <- list(name1,"more",setup1.fF.more,setup1.fF.more.perc,setup1.F.more,setup1.F.more.perc,setup1.FP.more,setup1.FP.more.perc,setup1.FN.more,setup1.FN.more.perc)
  setup1.less.data <- list(name1,"less",setup1.fF.less,setup1.fF.less.perc,setup1.F.less,setup1.F.less.perc,setup1.FP.less,setup1.FP.less.perc,setup1.FN.less,setup1.FN.less.perc)
  ggbar.df[1,] <- setup1.more.data
  ggbar.df[2,] <- setup1.less.data
}

if(!is.na(setup2)) {
  setup2.more.data <- list(name2,"more",setup2.fF.more,setup2.fF.more.perc,setup2.F.more,setup2.F.more.perc,setup2.FP.more,setup2.FP.more.perc,setup2.FN.more,setup2.FN.more.perc)
  setup2.less.data <- list(name2,"less",setup2.fF.less,setup2.fF.less.perc,setup2.F.less,setup2.F.less.perc,setup2.FP.less,setup2.FP.less.perc,setup2.FN.less,setup2.FN.less.perc)
  ggbar.df[3,] <- setup2.more.data
  ggbar.df[4,] <- setup2.less.data
}

if(!is.na(setup3)) {
  setup3.more.data <- list(name3,"more",setup3.fF.more,setup3.fF.more.perc,setup3.F.more,setup3.F.more.perc,setup3.FP.more,setup3.FP.more.perc,setup3.FN.more,setup3.FN.more.perc)
  setup3.less.data <- list(name3,"less",setup3.fF.less,setup3.fF.less.perc,setup3.F.less,setup3.F.less.perc,setup3.FP.less,setup3.FP.less.perc,setup3.FN.less,setup3.FN.less.perc)
  ggbar.df[5,] <- setup3.more.data
  ggbar.df[6,] <- setup3.less.data
}

if(!is.na(setup4)) {
  setup4.more.data <- list(name4,"more",setup4.fF.more,setup4.fF.more.perc,setup4.F.more,setup4.F.more.perc,setup4.FP.more,setup4.FP.more.perc,setup4.FN.more,setup4.FN.more.perc)
  setup4.less.data <- list(name4,"less",setup4.fF.less,setup4.fF.less.perc,setup4.F.less,setup4.F.less.perc,setup4.FP.less,setup4.FP.less.perc,setup4.FN.less,setup4.FN.less.perc)
  ggbar.df[7,] <- setup4.more.data
  ggbar.df[8,] <- setup4.less.data
}
