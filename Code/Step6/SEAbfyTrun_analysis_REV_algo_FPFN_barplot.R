...
ggplot(data = barplot.siteperc.df) + 
  ...
  labs(x = "SDM algorithm", y = "Mean false prediction percentage", fill=" ") +
  scale_fill_manual(values=c("#33BBEE","#882255"), 
                    labels=c("False positive      ","False negative      ")) #+
#scale_y_continuous(breaks = seq(0, 250, 50))

ggsave("algo_FPFNbar_count_mean_dodged_EMca.png", width = 30, height = 18.5, units = "cm", dpi = 800)
...
ggsave("algo_FPFNbar_count_fullmean_dodged_EMca.png", width = 30, height = 18.5, units = "cm", dpi = 800)
...
ggsave("algo_FPFNbar_count_mean_stacked_EMca.png", width = 28, height = 18.5, units = "cm", dpi = 800)


### Active: Mean stacked (full data) ###
ggplot(data = barplot.full.siteperc.df) + 
  geom_bar(aes(x = Algo, y = Mean, fill = Metric),stat = "identity", position = "stack") +
  geom_hline(yintercept = 0, color = "dark grey", linewidth=0.5) +
  theme(panel.grid.major = element_blank(), 
...
ggsave("algo_FPFNbar_count_fullmean_stacked_EMca.png", width = 28, height = 18.5, units = "cm", dpi = 800)
